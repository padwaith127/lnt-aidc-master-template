...
## Date: 24-May-2024
## Version: 1.0
## Tags: #LightingDesign #LED #EmergencyLighting #LuxLevels #{{ cookiecutter.project_code }} #NBC2016
## Related Files: [[Building_Management_Integration.md]], [[Standard_Operating_Procedures.md]], [[Preventive_and_Predictive.md]]
## Standards Covered: NBC 2016 (Part 8, Sec 1), IS 3646, IS 10322, NFPA 101, EN 12464-1, ASHRAE 90.1

---

## 1. Overview
In a {{ cookiecutter.it_capacity_mw }} MW AI facility, lighting is often overlooked, yet it is vital for operational safety and maintenance precision. In the {{ cookiecutter.city }} data centre, which houses high-density {{ cookiecutter.ai_silicon_vendor }} GPU clusters and complex liquid cooling manifolds, lighting must provide high visibility for technical tasks while minimizing energy consumption to support the facility's PUE (Power Usage Effectiveness) goals.
...
Based on **IS 3646** and **NBC 2016**, the following levels are mandatory for the {{ cookiecutter.project_name }} {{ cookiecutter.city }} site:
...
*   **Central Battery System (CBS) vs. Self-Contained:** For a {{ cookiecutter.it_capacity_mw }} MW facility, a **Central Battery System** is preferred for ease of testing and maintenance.
...
2.  **CRI (Color Rendering Index):** Specify **CRI > 80**. This is critical for identifying color-coded fiber optic patches and multi-colored internal wiring in {{ cookiecutter.ai_silicon_vendor }} power shelves.
...
### Revision History
* 1.0: Initial Lighting Strategy for {{ cookiecutter.project_name }} {{ cookiecutter.city }} project.

---
**Next File Recommendation:** `Level_1_to_Level_5_Testing.md` (Crucial for proving the {{ cookiecutter.it_capacity_mw }} MW plant is ready for AI deployment).
