...
## Purpose: To define the redundancy, availability, and operational requirements for the Mahape 40 MW facility to achieve Tier III certification.
## Revision: 1.0
## Date: 24-May-2024
## Version: 1.0
## Tags: #UptimeInstitute #TierIII #Redundancy #ConcurrentMaintainability #Availability #LTVyoma
## Related Files: [[Design_Basis_Report.md]], [[Project_Overview.md]], [[Standard_Operating_Procedures.md]]
## Standards Covered: Tier Standard: Topology (2020), Tier Standard: Operational Sustainability (2021)

---

## 1. Overview
The **Uptime Institute Tier Standard** is the most globally recognized methodology for ranking data centre reliability. For the L&T Mahape project, the target is **Tier III: Concurrently Maintainable**. This means that every component in the 40 MW power and cooling train can be removed from service for planned maintenance without impacting the IT load. 
...
**Mahape Target: Tier III.** We must ensure no "Single Point of Failure" exists that requires a site shutdown for maintenance.
...
*   **UPS Systems:** Must be N+1 at a minimum. In AI-ready designs, **2N (System+System)** is often used to ensure dual-path power to the NVIDIA racks.
...
*   **Gold/Silver/Bronze:** Based on the quality of SOPs, EOPs, and MOPs (Module 32) and the training of the L&T O&M team.
...
### Revision History
* 1.0: Mapped Uptime Tier III requirements for L&T Vyoma Mahape project.